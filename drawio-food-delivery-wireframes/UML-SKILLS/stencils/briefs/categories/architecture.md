# Architecture Diagram — Category Design Brief
...
- **Goal:** Present and render **Architecture Diagram** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 20 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **Card**, **Grid**, **System Context**, **Microservice**
...
- SVG source: `svg/shapes/architecture/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only architecture`
- Sprite symbol: `svg/shapes/sprite.svg#microservice`

## 5. Shapes in this category

`microservice`, `api-gateway`, `database`, `cache`, `message-queue`, `load-balancer`, `firewall`, `storage`, … (+12 more)
...
- [ ] Palette **accordion** section for `architecture`
