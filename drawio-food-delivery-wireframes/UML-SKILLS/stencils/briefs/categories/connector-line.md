# Connector & Line Types — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `connector-line`  
**Shape count:** 14  
**Version:** 1.0  
...
- **Goal:** Present and render **Connector & Line Types** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 14 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **Connector**, **Arrow**, **Dependency**, **Line**
...
- SVG source: `svg/shapes/connector-line/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only connector-line`
- Sprite symbol: `svg/shapes/sprite.svg#line-solid`

## 5. Shapes in this category

`line-solid`, `line-dashed`, `line-dotted`, `arrow-solid`, `arrow-open`, `arrow-dashed`, `arrow-double`, `arrow-hollow-triangle`, … (+6 more)
...
- [ ] Palette **accordion** section for `connector-line`
