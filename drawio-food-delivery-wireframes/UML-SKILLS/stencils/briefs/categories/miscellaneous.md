# Miscellaneous — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `miscellaneous`  
**Shape count:** 10  
**Version:** 1.0  
...
- **Goal:** Present and render **Miscellaneous** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 10 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **Legend**, **Note**, **Annotation**, **Title Block**
...
- SVG source: `svg/shapes/miscellaneous/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only miscellaneous`
- Sprite symbol: `svg/shapes/sprite.svg#note`

## 5. Shapes in this category

`note`, `constraint-text`, `tag`, `legend`, `title-block`, `timeline`, `milestone`, `phase`, … (+2 more)
...
- [ ] Palette **accordion** section for `miscellaneous`
