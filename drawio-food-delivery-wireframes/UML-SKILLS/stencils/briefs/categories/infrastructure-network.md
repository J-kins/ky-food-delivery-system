# Infrastructure & Network — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `infrastructure-network`  
**Shape count:** 9  
**Version:** 1.0  
...
- **Goal:** Present and render **Infrastructure & Network** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 9 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **Network**, **Subnet**, **Firewall**, **Topology**
...
- SVG source: `svg/shapes/infrastructure-network/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only infrastructure-network`
- Sprite symbol: `svg/shapes/sprite.svg#server`

## 5. Shapes in this category

`server`, `switch`, `router`, `firewall-network`, `load-balancer-network`, `vpn`, `internet`, `dmz`, … (+1 more)
...
- [ ] Palette **accordion** section for `infrastructure-network`
