# UML Package & Organizational — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `uml-package`  
**Shape count:** 7  
**Version:** 1.0  
...
- **Goal:** Present and render **UML Package & Organizational** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
...
- **Glossary terms:** **Folder**, **Namespace**, **Taxonomy**
...
- SVG source: `svg/shapes/uml-package/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only uml-package`
- Sprite symbol: `svg/shapes/sprite.svg#package`

## 5. Shapes in this category

`package`, `package-stereotype`, `model`, `subsystem`, `profile`, `package-import`, `package-merge`
...
- [ ] Palette **accordion** section for `uml-package`
