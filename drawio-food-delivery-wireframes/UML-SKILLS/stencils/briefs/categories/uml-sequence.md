# UML Sequence Diagram — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `uml-sequence`  
**Shape count:** 18  
**Version:** 1.0  
...
- **Goal:** Present and render **UML Sequence Diagram** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
...
- **Glossary terms:** **Timeline**, **Interaction**, **Focus**, **Microinteraction**
...
- SVG source: `svg/shapes/uml-sequence/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only uml-sequence`
- Sprite symbol: `svg/shapes/sprite.svg#lifeline`

## 5. Shapes in this category

`lifeline`, `actor-lifeline`, `activation-bar`, `sync-message`, `async-message`, `return-message`, `self-message`, `create-message`, … (+10 more)
...
- [ ] Palette **accordion** section for `uml-sequence`
