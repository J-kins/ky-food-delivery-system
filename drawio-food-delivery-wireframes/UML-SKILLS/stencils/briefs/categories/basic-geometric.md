# Basic Geometric Shapes — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `basic-geometric`  
**Shape count:** 16  
**Version:** 1.0  
...
- **Goal:** Present and render **Basic Geometric Shapes** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 16 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **Grid**, **Alignment**, **Container**, **Visual Hierarchy**
...
- SVG source: `svg/shapes/basic-geometric/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only basic-geometric`
- Sprite symbol: `svg/shapes/sprite.svg#rectangle`

## 5. Shapes in this category

`rectangle`, `rounded-rectangle`, `square`, `circle`, `ellipse`, `diamond`, `triangle`, `hexagon`, … (+8 more)
...
- [ ] Palette **accordion** section for `basic-geometric`
