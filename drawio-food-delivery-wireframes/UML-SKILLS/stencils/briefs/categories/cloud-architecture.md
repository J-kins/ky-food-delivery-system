# Cloud Architecture — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `cloud-architecture`  
**Shape count:** 16  
**Version:** 1.0  
...
- **Goal:** Present and render **Cloud Architecture** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
...
- **Glossary terms:** **Cloud**, **Region**, **Service**, **Card**
...
- SVG source: `svg/shapes/cloud-architecture/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only cloud-architecture`
- Sprite symbol: `svg/shapes/sprite.svg#aws-ec2`

## 5. Shapes in this category

`aws-ec2`, `aws-s3`, `aws-rds`, `aws-lambda`, `aws-api-gateway`, `aws-vpc`, `azure-vm`, `azure-blob`, … (+8 more)
...
- [ ] Palette **accordion** section for `cloud-architecture`
