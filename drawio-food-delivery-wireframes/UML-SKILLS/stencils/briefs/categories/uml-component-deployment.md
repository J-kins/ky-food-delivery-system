# UML Component & Deployment — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `uml-component-deployment`  
**Shape count:** 12  
**Version:** 1.0  
...
- **Goal:** Present and render **UML Component & Deployment** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 12 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **Component**, **Interface**, **Node**, **Deployment**
...
- SVG source: `svg/shapes/uml-component-deployment/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only uml-component-deployment`
- Sprite symbol: `svg/shapes/sprite.svg#component`

## 5. Shapes in this category

`component`, `component-lollipop`, `component-socket`, `interface-provided`, `interface-required`, `port`, `artifact`, `node`, … (+4 more)
...
- [ ] Palette **accordion** section for `uml-component-deployment`
