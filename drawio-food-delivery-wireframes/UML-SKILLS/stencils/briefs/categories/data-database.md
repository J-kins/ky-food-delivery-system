# Data & Database — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `data-database`  
**Shape count:** 8  
**Version:** 1.0  
...
- **Goal:** Present and render **Data & Database** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 8 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **Data Grid**, **Table**, **Relationship**
...
- SVG source: `svg/shapes/data-database/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only data-database`
- Sprite symbol: `svg/shapes/sprite.svg#table`

## 5. Shapes in this category

`table`, `view-db`, `stored-procedure`, `index-db`, `primary-key`, `foreign-key`, `table-relationship`, `er-entity`
...
- [ ] Palette **accordion** section for `data-database`
