# UML Use Case Diagram — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `uml-use-case`  
**Shape count:** 7  
**Version:** 1.0  
...
- **Goal:** Present and render **UML Use Case Diagram** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 7 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **Container**, **Actor**, **Boundary**, **Use Case**
...
- SVG source: `svg/shapes/uml-use-case/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only uml-use-case`
- Sprite symbol: `svg/shapes/sprite.svg#actor`

## 5. Shapes in this category

`actor`, `use-case`, `system-boundary`, `include-relationship`, `extend-relationship`, `actor-generalization`, `actor-head`
...
- [ ] Palette **accordion** section for `uml-use-case`
