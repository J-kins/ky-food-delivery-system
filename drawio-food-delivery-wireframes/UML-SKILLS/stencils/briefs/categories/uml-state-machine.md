# UML State Machine Diagram — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `uml-state-machine`  
**Shape count:** 18  
**Version:** 1.0  
...
- **Goal:** Present and render **UML State Machine Diagram** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 18 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **State**, **Transition**, **Visual Hierarchy**
...
- SVG source: `svg/shapes/uml-state-machine/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only uml-state-machine`
- Sprite symbol: `svg/shapes/sprite.svg#state`

## 5. Shapes in this category

`state`, `sm-initial-state`, `sm-final-state`, `choice-pseudostate`, `fork-pseudostate`, `join-pseudostate`, `deep-history`, `shallow-history`, … (+10 more)
...
- [ ] Palette **accordion** section for `uml-state-machine`
