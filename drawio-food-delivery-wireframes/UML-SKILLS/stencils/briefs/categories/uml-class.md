# UML Class Diagram — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `uml-class`  
**Shape count:** 16  
**Version:** 1.0  
...
- **Goal:** Present and render **UML Class Diagram** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
...
- **Glossary terms:** **Card**, **Typography**, **Affordance**, **Progressive Disclosure**
...
- SVG source: `svg/shapes/uml-class/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only uml-class`
- Sprite symbol: `svg/shapes/sprite.svg#class-box`

## 5. Shapes in this category

`class-box`, `abstract-class`, `interface-box`, `enumeration`, `stereotype`, `attribute`, `method`, `visibility-marker`, … (+8 more)
...
- [ ] Palette **accordion** section for `uml-class`
