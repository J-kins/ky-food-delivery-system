# UML Activity Diagram — Category Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category ID:** `uml-activity`  
**Shape count:** 22  
**Version:** 1.0  
...
- **Goal:** Present and render **UML Activity Diagram** shapes with consistent PrimeReact enterprise aesthetics in the palette and on the diagram canvas.
- **Scope:** 22 stencil shapes — see [SHAPE_LIBRARY.md](../svg/SHAPE_LIBRARY.md).
...
- **Glossary terms:** **Wizard**, **Decision**, **Swimlane**, **Flow**
...
- SVG source: `svg/shapes/uml-activity/<shape-id>.svg`
- Regenerate assets: `python svg/scripts/generate_shapes.py --only uml-activity`
- Sprite symbol: `svg/shapes/sprite.svg#initial-node`

## 5. Shapes in this category

`initial-node`, `final-node`, `flow-final-node`, `action`, `activity`, `decision-node`, `merge-node`, `fork-node`, … (+14 more)
...
- [ ] Palette **accordion** section for `uml-activity`
