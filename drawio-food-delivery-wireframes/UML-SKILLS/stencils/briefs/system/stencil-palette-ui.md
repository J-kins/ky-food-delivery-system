# Stencil Palette UI — UI/UX Design Brief
...
- **Goal:** Left sidebar for discovering and inserting shapes.
...
- **Personas:** Power users who need fast shape lookup across 200+ stencils.
- **Primary flow:** Search/filter → expand category → drag or double-click shape → place on canvas.
