# Export Dialog UI — UI/UX Design Brief
...
- **Goal:** Export finished diagrams to SVG, PNG, or PDF.
...
- **Personas:** Authors sharing diagrams in docs, slides, or wikis.
- **Primary flow:** File → Export → choose format → preview → confirm → **toast** success.
