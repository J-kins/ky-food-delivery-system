# Stencil System — UI/UX Design Brief
...
- **Goal:** End-to-end diagramming app shell for UML & architecture stencils.
...
- **Personas:** Enterprise architects, developers, BA/PMs creating technical diagrams.
- **Primary flow:** Open app → browse palette → compose diagram → inspect properties → export SVG/PNG.
