# Stored Procedure — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Data & Database (`data-database`)  
**Shape ID:** `stored-procedure`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/data-database/stored-procedure.svg`  
**Version:** 1.0  
...
- **Goal:** Stored procedure
- **Description:** Rectangle <<sp>>
- **Visual notation:** `┌<<sp>>┘`
...
|----------|---------|---------|
| Label | **InputText** | `Stored Procedure` |
...
- Tile `aria-label="Stored Procedure"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/data-database/stored-procedure.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#stored-procedure`
