...
- **Goal:** Foreign key
- **Description:** Column with FK
- **Visual notation:** `id FK`
...
- Tile `aria-label="Foreign Key"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#foreign-key`
