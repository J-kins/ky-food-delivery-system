...
- **Goal:** Primary key
- **Description:** Column with PK
- **Visual notation:** `id PK`
...
- Tile `aria-label="Primary Key"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#primary-key`
