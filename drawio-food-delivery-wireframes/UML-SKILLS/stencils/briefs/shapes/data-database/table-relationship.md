# Relationship — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Data & Database (`data-database`)  
**Shape ID:** `table-relationship`  
**Asset type:** `connector` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/data-database/table-relationship.svg`  
**Version:** 1.0  
...
- **Goal:** Table relationship
- **Description:** Line with cardinalities
- **Visual notation:** `1 ─── *`
...
- **Diagram types:** Data & Database diagrams.
- **Palette tile:** 48×48 **card** tile in `data-database` **accordion** section.
...
- Tile `aria-label="Relationship"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/data-database/table-relationship.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#table-relationship`
