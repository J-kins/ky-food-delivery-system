...
- **Goal:** Message ordering
- **Description:** Numbered labels
- **Visual notation:** `1, 1.1, 2`
...
|----------|---------|---------|
| Label | **InputText** | `Message Number` |
...
- Tile `aria-label="Message Number"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#message-number`
