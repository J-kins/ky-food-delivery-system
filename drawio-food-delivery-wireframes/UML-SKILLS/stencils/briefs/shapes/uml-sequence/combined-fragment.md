# Combined Fragment — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Sequence Diagram (`uml-sequence`)  
**Shape ID:** `combined-fragment`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-sequence/combined-fragment.svg`  
**Version:** 1.0  
...
- **Goal:** Loops, conditions
- **Description:** Rectangle with operator
- **Visual notation:** `┌ alt ┘`
...
|----------|---------|---------|
| Label | **InputText** | `Combined Fragment` |
...
- Tile `aria-label="Combined Fragment"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-sequence/combined-fragment.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#combined-fragment`
