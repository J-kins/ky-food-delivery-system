...
- **Goal:** Execution period
- **Description:** Thin vertical rectangle
- **Visual notation:** `┌─┐││└─┘`
...
|----------|---------|---------|
| Label | **InputText** | `Activation Bar` |
...
- Tile `aria-label="Activation Bar"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-sequence/activation-bar.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#activation-bar`
