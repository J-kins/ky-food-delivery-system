...
- **Goal:** Repetition
- **Description:** Combined fragment loop
- **Visual notation:** `┌ loop ┘`
...
- Tile `aria-label="Loop Fragment"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-sequence/loop-fragment.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#loop-fragment`
