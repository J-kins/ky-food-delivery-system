...
- **Description:** Dashed arrow <<create>>
- **Visual notation:** `─ ─ ▶ <<create>>`
...
|----------|---------|---------|
| Label | **InputText** | `Create Message` |
...
- Tile `aria-label="Create Message"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-sequence/create-message.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#create-message`
