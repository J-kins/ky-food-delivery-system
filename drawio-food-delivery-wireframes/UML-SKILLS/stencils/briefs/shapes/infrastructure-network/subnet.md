...
**SVG:** `../svg/shapes/infrastructure-network/subnet.svg`  
**Version:** 1.0  
...
- **Goal:** Network subnet
- **Description:** Rectangle CIDR
- **Visual notation:** `10.0.1.0/24`
