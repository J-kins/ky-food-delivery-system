...
**SVG:** `../svg/shapes/infrastructure-network/switch.svg`  
**Version:** 1.0  
...
- **Goal:** Network switch
- **Description:** Rectangle with ports
- **Visual notation:** `Switch`
