# Load Balancer — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Infrastructure & Network (`infrastructure-network`)  
**Shape ID:** `load-balancer-network`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/infrastructure-network/load-balancer-network.svg`  
**Version:** 1.0  
...
- **Goal:** Network load balancer
- **Description:** Rectangle LB
- **Visual notation:** `LB`
...
- Tile `aria-label="Load Balancer"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/infrastructure-network/load-balancer-network.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#load-balancer-network`
