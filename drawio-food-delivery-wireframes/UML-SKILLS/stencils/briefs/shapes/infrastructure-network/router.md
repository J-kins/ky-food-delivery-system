...
**SVG:** `../svg/shapes/infrastructure-network/router.svg`  
**Version:** 1.0  
...
- **Goal:** Network router
- **Description:** Rectangle with antennas
- **Visual notation:** `Router`
