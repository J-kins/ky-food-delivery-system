...
**SVG:** `../svg/shapes/infrastructure-network/server.svg`  
**Version:** 1.0  
...
- **Goal:** Physical server
- **Description:** 3D rectangle rack
- **Visual notation:** `Server`
