# Title Block — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Miscellaneous (`miscellaneous`)  
**Shape ID:** `title-block`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/miscellaneous/title-block.svg`  
**Version:** 1.0  
...
- **Goal:** Document header
- **Description:** Project info block
- **Visual notation:** `Project`
