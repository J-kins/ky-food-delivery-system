# Number — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Miscellaneous (`miscellaneous`)  
**Shape ID:** `sequence-number`  
...
- **Goal:** Sequence numbers
- **Description:** Text label
- **Visual notation:** `1, 2, 3`
...
- Tile `aria-label="Number"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#sequence-number`
