# Condition — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Miscellaneous (`miscellaneous`)  
**Shape ID:** `condition-text`  
...
- Tile `aria-label="Condition"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#condition-text`
