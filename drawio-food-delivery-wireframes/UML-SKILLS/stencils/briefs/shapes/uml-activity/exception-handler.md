# Exception Handler — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Activity Diagram (`uml-activity`)  
**Shape ID:** `exception-handler`  
**Asset type:** `shape` | **Delivery:** `manual`  
**SVG:** `../svg/shapes/uml-activity/exception-handler.svg`  
**Version:** 1.0  
...
|----------|---------|---------|
| Label | **InputText** | `Exception Handler` |
...
- Tile `aria-label="Exception Handler"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-activity/exception-handler.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#exception-handler`
