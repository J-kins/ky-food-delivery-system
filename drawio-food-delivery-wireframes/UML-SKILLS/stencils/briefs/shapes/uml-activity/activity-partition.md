# Activity Partition — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Activity Diagram (`uml-activity`)  
**Shape ID:** `activity-partition`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-activity/activity-partition.svg`  
**Version:** 1.0  
...
- **Goal:** Organization grouping
- **Description:** Swimlane with label
- **Visual notation:** `┌ Role ┘`
...
|----------|---------|---------|
| Label | **InputText** | `Activity Partition` |
...
- Tile `aria-label="Activity Partition"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-activity/activity-partition.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#activity-partition`
