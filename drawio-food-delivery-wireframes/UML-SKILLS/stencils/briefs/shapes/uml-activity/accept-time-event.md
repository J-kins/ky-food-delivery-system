# Accept Time Event — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Activity Diagram (`uml-activity`)  
**Shape ID:** `accept-time-event`  
**Asset type:** `shape` | **Delivery:** `manual`  
**SVG:** `../svg/shapes/uml-activity/accept-time-event.svg`  
**Version:** 1.0  
...
- **Goal:** Time-based trigger
- **Description:** Hourglass shape
- **Visual notation:** `⏳`
...
|----------|---------|---------|
| Label | **InputText** | `Accept Time Event` |
...
- Tile `aria-label="Accept Time Event"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-activity/accept-time-event.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#accept-time-event`
