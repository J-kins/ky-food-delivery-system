...
- **Goal:** Receiving signal
- **Description:** Jagged edge shape
- **Visual notation:** `┌──╲│`
...
- Tile `aria-label="Accept Signal"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-activity/accept-signal.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#accept-signal`
