# Interrupting Flow — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Activity Diagram (`uml-activity`)  
**Shape ID:** `interrupting-flow`  
**Asset type:** `connector` | **Delivery:** `manual`  
**SVG:** `../svg/shapes/uml-activity/interrupting-flow.svg`  
**Version:** 1.0  
...
- **Goal:** Flow interruption
- **Description:** Arrow with bolt
- **Visual notation:** `─────▶⚡`
...
|----------|---------|---------|
| Label | **InputText** | `Interrupting Flow` |
...
- Tile `aria-label="Interrupting Flow"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-activity/interrupting-flow.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#interrupting-flow`
