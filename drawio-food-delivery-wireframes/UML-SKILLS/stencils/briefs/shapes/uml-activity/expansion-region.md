...
- **Goal:** Multi-element area
- **Description:** Dashed border rectangle
- **Visual notation:** `┌─ ─ ─┘`
...
|----------|---------|---------|
| Label | **InputText** | `Expansion Region` |
...
- Tile `aria-label="Expansion Region"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-activity/expansion-region.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#expansion-region`
