...
- **Goal:** Required interface
- **Description:** Component + required IF
- **Visual notation:** `┌───(`
...
|----------|---------|---------|
| Label | **InputText** | `Component with Socket` |
...
- Tile `aria-label="Component with Socket"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-component-deployment/component-socket.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#component-socket`
