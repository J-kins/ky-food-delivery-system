# Interface (Provided) — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Component & Deployment (`uml-component-deployment`)  
**Shape ID:** `interface-provided`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-component-deployment/interface-provided.svg`  
**Version:** 1.0  
...
|----------|---------|---------|
| Label | **InputText** | `Interface (Provided)` |
...
- Tile `aria-label="Interface (Provided)"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-component-deployment/interface-provided.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#interface-provided`
