...
**SVG:** `../svg/shapes/uml-component-deployment/component.svg`  
**Version:** 1.0  
...
- **Goal:** System component
- **Description:** Rectangle <<component>>
- **Visual notation:** `┌<<component>>┘`
...
- Tile `aria-label="Component"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-component-deployment/component.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#component`
