...
**SVG:** `../svg/shapes/uml-component-deployment/device.svg`  
**Version:** 1.0  
...
- **Goal:** Hardware device
- **Description:** Node <<device>>
- **Visual notation:** `┌<<device>>┘`
