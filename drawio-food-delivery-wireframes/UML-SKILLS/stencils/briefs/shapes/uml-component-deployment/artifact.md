...
**SVG:** `../svg/shapes/uml-component-deployment/artifact.svg`  
**Version:** 1.0  
...
- **Goal:** Deployment artifact
- **Description:** Rectangle <<artifact>>
- **Visual notation:** `┌<<artifact>>┘`
