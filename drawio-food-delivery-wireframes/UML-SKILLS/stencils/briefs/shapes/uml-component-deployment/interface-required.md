# Interface (Required) — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Component & Deployment (`uml-component-deployment`)  
**Shape ID:** `interface-required`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-component-deployment/interface-required.svg`  
**Version:** 1.0  
...
|----------|---------|---------|
| Label | **InputText** | `Interface (Required)` |
...
- Tile `aria-label="Interface (Required)"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-component-deployment/interface-required.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#interface-required`
