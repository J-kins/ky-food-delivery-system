...
**SVG:** `../svg/shapes/uml-component-deployment/node.svg`  
**Version:** 1.0  
...
- **Goal:** Physical resource
- **Description:** 3D rectangle
- **Visual notation:** `┌ Node ┘`
