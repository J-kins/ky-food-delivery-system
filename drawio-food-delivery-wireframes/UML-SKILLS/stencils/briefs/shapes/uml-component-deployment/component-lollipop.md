# Component with Lollipop — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Component & Deployment (`uml-component-deployment`)  
**Shape ID:** `component-lollipop`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-component-deployment/component-lollipop.svg`  
**Version:** 1.0  
...
- **Goal:** Provided interface
- **Description:** Component + provided IF
- **Visual notation:** `┌───○`
...
|----------|---------|---------|
| Label | **InputText** | `Component with Lollipop` |
...
- Tile `aria-label="Component with Lollipop"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-component-deployment/component-lollipop.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#component-lollipop`
