# Rounded Rectangle — Shape Design Brief
...
**SVG:** `../svg/shapes/basic-geometric/rounded-rectangle.svg`  
**Version:** 1.0  
...
- **Goal:** Activities, actions, use cases
- **Description:** Rectangle with rounded corners
- **Visual notation:** `▭ (rounded)`
...
|----------|---------|---------|
| Label | **InputText** | `Rounded Rectangle` |
...
- Tile `aria-label="Rounded Rectangle"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/basic-geometric/rounded-rectangle.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#rounded-rectangle`
