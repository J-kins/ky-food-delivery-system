# Bracket — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Basic Geometric Shapes (`basic-geometric`)  
**Shape ID:** `bracket`  
**Asset type:** `shape` | **Delivery:** `manual`  
**SVG:** `../svg/shapes/basic-geometric/bracket.svg`  
**Version:** 1.0  
...
- **Goal:** Constraints, stereotypes
- **Description:** Curved or angled brackets
- **Visual notation:** `[ ]`
...
- **Diagram types:** Basic Geometric Shapes diagrams.
- **Palette tile:** 48×48 **card** tile in `basic-geometric` **accordion** section.
- **Glossary terms:** **Grid**, **Alignment**, **Container**
