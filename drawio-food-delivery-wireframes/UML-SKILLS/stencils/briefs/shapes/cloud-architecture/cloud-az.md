...
- **Goal:** Availability zone
- **Description:** Box with AZ label
- **Visual notation:** `AZ-A`
...
|----------|---------|---------|
| Label | **InputText** | `Cloud Availability Zone` |
...
- Tile `aria-label="Cloud Availability Zone"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/cloud-architecture/cloud-az.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#cloud-az`
