...
|----------|---------|---------|
| Label | **InputText** | `GCP Cloud Storage` |
...
- Tile `aria-label="GCP Cloud Storage"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/cloud-architecture/gcp-storage.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#gcp-storage`
