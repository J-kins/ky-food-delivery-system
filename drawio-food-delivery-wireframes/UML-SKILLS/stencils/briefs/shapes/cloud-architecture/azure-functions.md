# Azure Functions — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Cloud Architecture (`cloud-architecture`)  
**Shape ID:** `azure-functions`  
**Asset type:** `shape` | **Delivery:** `manual`  
**SVG:** `../svg/shapes/cloud-architecture/azure-functions.svg`  
**Version:** 1.0  
...
|----------|---------|---------|
| Label | **InputText** | `Azure Functions` |
...
- Tile `aria-label="Azure Functions"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/cloud-architecture/azure-functions.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#azure-functions`
