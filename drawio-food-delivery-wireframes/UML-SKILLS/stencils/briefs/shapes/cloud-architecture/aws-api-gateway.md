# AWS API Gateway — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Cloud Architecture (`cloud-architecture`)  
**Shape ID:** `aws-api-gateway`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/cloud-architecture/aws-api-gateway.svg`  
**Version:** 1.0  
...
- **Goal:** AWS API gateway
- **Description:** AWS APIG icon
- **Visual notation:** `APIG`
...
- **Diagram types:** Cloud Architecture diagrams.
- **Palette tile:** 48×48 **card** tile in `cloud-architecture` **accordion** section.
- **Glossary terms:** **Cloud**, **Region**, **Service**
- **Notes:** Auto-generated SVG — restyle with Prime tokens in `generate_shapes.py`. Official icons: https://aws.amazon.com/architecture/icons/
...
|----------|---------|---------|
| Label | **InputText** | `AWS API Gateway` |
...
- Tile `aria-label="AWS API Gateway"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/cloud-architecture/aws-api-gateway.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#aws-api-gateway`
