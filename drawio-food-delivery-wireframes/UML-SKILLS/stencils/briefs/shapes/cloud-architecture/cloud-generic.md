...
- **Goal:** Fallback cloud node
- **Description:** Generic cloud service box
- **Visual notation:** `Cloud`
...
- Tile `aria-label="Cloud Generic"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/cloud-architecture/cloud-generic.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#cloud-generic`
