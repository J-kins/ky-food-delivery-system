# Completion Transition — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML State Machine Diagram (`uml-state-machine`)  
**Shape ID:** `completion-transition`  
**Asset type:** `connector` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-state-machine/completion-transition.svg`  
**Version:** 1.0  
...
|----------|---------|---------|
| Label | **InputText** | `Completion Transition` |
...
- Tile `aria-label="Completion Transition"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-state-machine/completion-transition.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#completion-transition`
