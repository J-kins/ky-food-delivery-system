# Choice Pseudo-state — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML State Machine Diagram (`uml-state-machine`)  
**Shape ID:** `choice-pseudostate`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-state-machine/choice-pseudostate.svg`  
**Version:** 1.0  
...
|----------|---------|---------|
| Label | **InputText** | `Choice Pseudo-state` |
...
- Tile `aria-label="Choice Pseudo-state"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-state-machine/choice-pseudostate.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#choice-pseudostate`
