...
- **Goal:** History shallow
- **Description:** Circle with H
- **Visual notation:** `H`
...
|----------|---------|---------|
| Label | **InputText** | `Shallow History` |
...
- Tile `aria-label="Shallow History"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-state-machine/shallow-history.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#shallow-history`
