...
**SVG:** `../svg/shapes/uml-state-machine/transition.svg`  
**Version:** 1.0  
...
- **Goal:** State change
- **Description:** Solid arrow with label
- **Visual notation:** `────▶ trigger`
