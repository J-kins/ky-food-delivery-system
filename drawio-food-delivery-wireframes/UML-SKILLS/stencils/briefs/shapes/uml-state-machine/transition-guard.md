...
- **Goal:** Condition for transition
- **Description:** Text in brackets
- **Visual notation:** `[condition]`
...
|----------|---------|---------|
| Label | **InputText** | `Transition Guard` |
...
- Tile `aria-label="Transition Guard"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#transition-guard`
