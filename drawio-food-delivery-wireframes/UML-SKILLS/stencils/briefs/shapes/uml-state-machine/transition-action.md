...
- **Goal:** Activity on transition
- **Description:** Text with slash
- **Visual notation:** `/ action`
...
|----------|---------|---------|
| Label | **InputText** | `Transition Action` |
...
- Tile `aria-label="Transition Action"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#transition-action`
