# Off-page Connector — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Process & Flow (`process-flow`)  
**Shape ID:** `off-page-connector`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/process-flow/off-page-connector.svg`  
**Version:** 1.0  
...
- **Goal:** Connector to another page
...
|----------|---------|---------|
| Label | **InputText** | `Off-page Connector` |
...
- Tile `aria-label="Off-page Connector"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/process-flow/off-page-connector.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#off-page-connector`
