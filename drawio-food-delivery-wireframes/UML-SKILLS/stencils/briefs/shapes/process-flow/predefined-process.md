# Predefined Process — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Process & Flow (`process-flow`)  
**Shape ID:** `predefined-process`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/process-flow/predefined-process.svg`  
**Version:** 1.0  
...
- **Goal:** Subroutine
- **Description:** Double border rectangle
- **Visual notation:** `Process`
...
|----------|---------|---------|
| Label | **InputText** | `Predefined Process` |
...
- Tile `aria-label="Predefined Process"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/process-flow/predefined-process.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#predefined-process`
