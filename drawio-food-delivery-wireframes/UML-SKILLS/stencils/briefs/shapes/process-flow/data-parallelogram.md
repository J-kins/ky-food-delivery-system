# Data — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Process & Flow (`process-flow`)  
**Shape ID:** `data-parallelogram`  
**Asset type:** `shape` | **Delivery:** `manual`  
**SVG:** `../svg/shapes/process-flow/data-parallelogram.svg`  
**Version:** 1.0  
...
- Tile `aria-label="Data"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/process-flow/data-parallelogram.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#data-parallelogram`
