...
- **Goal:** Class properties
- **Description:** Text in class box
- **Visual notation:** `+ name: Type`
...
- Tile `aria-label="Attribute"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#attribute`
