...
|----------|---------|---------|
| Label | **InputText** | `Visibility Marker` |
...
- Tile `aria-label="Visibility Marker"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#visibility-marker`
