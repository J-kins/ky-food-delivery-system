...
- **Goal:** Abstract classes
- **Description:** Class with italic name
- **Visual notation:** `┌*Class*┘`
...
|----------|---------|---------|
| Label | **InputText** | `Abstract Class` |
...
- Tile `aria-label="Abstract Class"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-class/abstract-class.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#abstract-class`
