...
- **Goal:** Marking UML elements
- **Description:** Text in guillemets
- **Visual notation:** `<<stereotype>>`
...
- Tile `aria-label="Stereotype"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#stereotype`
