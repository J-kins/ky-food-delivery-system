...
- **Goal:** Class operations
- **Description:** Text in class box
- **Visual notation:** `+ method(): ReturnType`
...
- Tile `aria-label="Method"`; canvas shape `role="img"` with descriptive label.
...
- [ ] Listed in `sprite.svg` symbol `#method`
