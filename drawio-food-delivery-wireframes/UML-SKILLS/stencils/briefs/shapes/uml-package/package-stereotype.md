# Package with Stereotype — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Package & Organizational (`uml-package`)  
**Shape ID:** `package-stereotype`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-package/package-stereotype.svg`  
**Version:** 1.0  
...
- **Goal:** Typed package
- **Description:** Package <<stereotype>>
- **Visual notation:** `┌<<st>> Package┘`
...
- **Diagram types:** UML Package & Organizational diagrams.
- **Palette tile:** 48×48 **card** tile in `uml-package` **accordion** section.
...
|----------|---------|---------|
| Label | **InputText** | `Package with Stereotype` |
...
- Tile `aria-label="Package with Stereotype"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-package/package-stereotype.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#package-stereotype`
