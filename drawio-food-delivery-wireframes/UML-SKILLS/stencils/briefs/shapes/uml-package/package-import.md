...
- **Goal:** Package dependency
- **Description:** Dashed arrow <<import>>
- **Visual notation:** `─ ─ ▶ <<import>>`
...
|----------|---------|---------|
| Label | **InputText** | `Package Import` |
...
- Tile `aria-label="Package Import"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-package/package-import.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#package-import`
