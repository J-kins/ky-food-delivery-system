# Solid Triangle Arrow — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Connector & Line Types (`connector-line`)  
**Shape ID:** `arrow-hollow-triangle`  
**Asset type:** `connector` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/connector-line/arrow-hollow-triangle.svg`  
**Version:** 1.0  
...
|----------|---------|---------|
| Label | **InputText** | `Solid Triangle Arrow` |
...
- Tile `aria-label="Solid Triangle Arrow"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/connector-line/arrow-hollow-triangle.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#arrow-hollow-triangle`
