...
**Shape ID:** `line-dotted`  
**Asset type:** `connector` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/connector-line/line-dotted.svg`  
**Version:** 1.0  
...
- **Goal:** Weak relationship
- **Description:** Dotted connector
- **Visual notation:** `· · · · ·`
...
- [ ] SVG asset at `../svg/shapes/connector-line/line-dotted.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#line-dotted`
