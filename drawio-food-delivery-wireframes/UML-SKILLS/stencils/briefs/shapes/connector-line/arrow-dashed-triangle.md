# Dashed Triangle Arrow — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Connector & Line Types (`connector-line`)  
**Shape ID:** `arrow-dashed-triangle`  
**Asset type:** `connector` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/connector-line/arrow-dashed-triangle.svg`  
**Version:** 1.0  
...
- **Goal:** Realization
- **Description:** Dashed hollow triangle
- **Visual notation:** `─ ─ ─ ─ △`
...
|----------|---------|---------|
| Label | **InputText** | `Dashed Triangle Arrow` |
...
- Tile `aria-label="Dashed Triangle Arrow"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/connector-line/arrow-dashed-triangle.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#arrow-dashed-triangle`
