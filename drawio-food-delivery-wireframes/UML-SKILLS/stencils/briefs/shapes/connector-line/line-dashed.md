...
**Shape ID:** `line-dashed`  
**Asset type:** `connector` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/connector-line/line-dashed.svg`  
**Version:** 1.0  
...
- **Goal:** Dependency, optional
- **Description:** Dashed connector
- **Visual notation:** `─ ─ ─ ─ ─`
...
- [ ] SVG asset at `../svg/shapes/connector-line/line-dashed.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#line-dashed`
