...
|----------|---------|---------|
| Label | **InputText** | `Hollow Diamond` |
...
- Tile `aria-label="Hollow Diamond"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/connector-line/diamond-hollow-end.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#diamond-hollow-end`
