...
|----------|---------|---------|
| Label | **InputText** | `Double-headed Arrow` |
...
- Tile `aria-label="Double-headed Arrow"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/connector-line/arrow-double.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#arrow-double`
