...
**Shape ID:** `load-balancer`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/architecture/load-balancer.svg`  
**Version:** 1.0  
...
- [ ] SVG asset at `../svg/shapes/architecture/load-balancer.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#load-balancer`
