# Persistent Volume — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** Architecture Diagram (`architecture`)  
**Shape ID:** `persistent-volume`  
**Asset type:** `shape` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/architecture/persistent-volume.svg`  
**Version:** 1.0  
...
|----------|---------|---------|
| Label | **InputText** | `Persistent Volume` |
...
- Tile `aria-label="Persistent Volume"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/architecture/persistent-volume.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#persistent-volume`
