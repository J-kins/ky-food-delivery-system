...
**SVG:** `../svg/shapes/architecture/firewall.svg`  
**Version:** 1.0  
...
- **Goal:** Firewall
- **Description:** Rectangle <<fw>>
- **Visual notation:** `┌<<fw>> FW┘`
...
- [ ] SVG asset at `../svg/shapes/architecture/firewall.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#firewall`
