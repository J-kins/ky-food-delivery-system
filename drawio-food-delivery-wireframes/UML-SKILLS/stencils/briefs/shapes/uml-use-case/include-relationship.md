# Include — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Use Case Diagram (`uml-use-case`)  
**Shape ID:** `include-relationship`  
**Asset type:** `connector` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-use-case/include-relationship.svg`  
**Version:** 1.0  
...
- **Goal:** Required functionality
- **Description:** Dashed arrow <<include>>
- **Visual notation:** `─ ─ ▶ <<include>>`
...
- **Diagram types:** UML Use Case Diagram diagrams.
- **Palette tile:** 48×48 **card** tile in `uml-use-case` **accordion** section.
- **Glossary terms:** **Container**, **Actor**, **Boundary**
...
- Tile `aria-label="Include"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-use-case/include-relationship.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#include-relationship`
