...
- **Goal:** System scope
- **Description:** Rectangle with name
...
|----------|---------|---------|
| Label | **InputText** | `System Boundary` |
...
- Tile `aria-label="System Boundary"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-use-case/system-boundary.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#system-boundary`
