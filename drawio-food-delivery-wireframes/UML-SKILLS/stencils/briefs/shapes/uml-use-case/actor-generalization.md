# Generalization — Shape Design Brief

**Project:** UML-SKILLS Stencil Toolkit  
**Category:** UML Use Case Diagram (`uml-use-case`)  
**Shape ID:** `actor-generalization`  
**Asset type:** `connector` | **Delivery:** `generate`  
**SVG:** `../svg/shapes/uml-use-case/actor-generalization.svg`  
**Version:** 1.0  
...
- **Goal:** Actor inheritance
- **Description:** Hollow triangle line
- **Visual notation:** `△───────────`
...
|----------|---------|---------|
| Label | **InputText** | `Generalization` |
...
- Tile `aria-label="Generalization"`; canvas shape `role="img"` with descriptive label.
- **Keyboard accessible** move/resize when selected.
- **Contrast ratio** check for text inside shape bounds.

## 8. Deliverables Checklist

- [ ] SVG asset at `../svg/shapes/uml-use-case/actor-generalization.svg`
- [ ] Palette thumbnail (default + **hover** + **focus**)
- [ ] Canvas instance (default + selected)
- [ ] Listed in `sprite.svg` symbol `#actor-generalization`
