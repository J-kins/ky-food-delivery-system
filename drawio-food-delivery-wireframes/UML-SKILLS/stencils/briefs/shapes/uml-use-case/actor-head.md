...
- **Goal:** Actor icon part
- **Description:** Ellipse for stick figure head
- **Visual notation:** `◯`
...
- **Notes:** Auto-generated SVG — restyle with Prime tokens in `generate_shapes.py`. Sub-part of actor; use actor.svg for full figure
