# Azure Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Cloud Architecture Diagrams (`cloud`)  
**Template ID:** `azure-architecture`  
**Layout:** `cloud_provider`  
**SVG:** `../svg/cloud/75-azure-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Azure Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Azure VNet, VM, Blob, SQL layout
...
| Template title | read-only **InputText** | `Azure Architecture` |
