# Serverless Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Cloud Architecture Diagrams (`cloud`)  
**Template ID:** `serverless-architecture`  
**Layout:** `serverless`  
**SVG:** `../svg/cloud/78-serverless-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Serverless Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** API Gateway, functions, datastore
...
| Template title | read-only **InputText** | `Serverless Architecture` |
...
- Canvas `aria-label="Serverless Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/cloud/78-serverless-architecture-template.svg`
