# AWS Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Cloud Architecture Diagrams (`cloud`)  
**Template ID:** `aws-architecture`  
**Layout:** `cloud_provider`  
**SVG:** `../svg/cloud/74-aws-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **AWS Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** AWS VPC, EC2, S3, RDS layout
...
| Template title | read-only **InputText** | `AWS Architecture` |
