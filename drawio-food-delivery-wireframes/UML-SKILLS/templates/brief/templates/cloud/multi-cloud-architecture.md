# Multi-Cloud Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Cloud Architecture Diagrams (`cloud`)  
**Template ID:** `multi-cloud-architecture`  
**Layout:** `multi_cloud`  
**SVG:** `../svg/cloud/77-multi-cloud-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Multi-Cloud Architecture** so users begin with correct structure, guides, and placeholder regions.
...
| Template title | read-only **InputText** | `Multi-Cloud Architecture` |
...
- Canvas `aria-label="Multi-Cloud Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/cloud/77-multi-cloud-architecture-template.svg`
