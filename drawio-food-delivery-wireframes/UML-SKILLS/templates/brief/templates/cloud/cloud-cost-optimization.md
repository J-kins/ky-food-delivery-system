# Cloud Cost Optimization — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Cloud Architecture Diagrams (`cloud`)  
**Template ID:** `cloud-cost-optimization`  
**Layout:** `cost_optimization`  
**SVG:** `../svg/cloud/80-cloud-cost-optimization-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Cloud Cost Optimization** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Cost, resource, and optimization areas
...
| Template title | read-only **InputText** | `Cloud Cost Optimization` |
...
- Canvas `aria-label="Cloud Cost Optimization template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/cloud/80-cloud-cost-optimization-template.svg`
