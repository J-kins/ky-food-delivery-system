# GCP Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Cloud Architecture Diagrams (`cloud`)  
**Template ID:** `gcp-architecture`  
**Layout:** `cloud_provider`  
**SVG:** `../svg/cloud/76-gcp-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **GCP Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** GCP VPC, Compute, Storage, BigQuery
...
| Template title | read-only **InputText** | `GCP Architecture` |
