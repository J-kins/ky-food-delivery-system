# Workflow Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Process & Flow Diagrams (`process-flow`)  
**Template ID:** `workflow-diagram`  
**Layout:** `workflow_swimlanes`  
**SVG:** `../svg/process-flow/61-workflow-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Workflow Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Workflow activities in swimlanes
...
| Template title | read-only **InputText** | `Workflow Diagram` |
...
- Canvas `aria-label="Workflow Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/process-flow/61-workflow-diagram-template.svg`
