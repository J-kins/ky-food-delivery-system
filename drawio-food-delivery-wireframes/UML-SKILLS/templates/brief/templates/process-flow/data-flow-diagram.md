# Data Flow Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Process & Flow Diagrams (`process-flow`)  
**Template ID:** `data-flow-diagram`  
**Layout:** `dfd`  
**SVG:** `../svg/process-flow/58-data-flow-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Data Flow Diagram** so users begin with correct structure, guides, and placeholder regions.
...
| Template title | read-only **InputText** | `Data Flow Diagram` |
...
- Canvas `aria-label="Data Flow Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/process-flow/58-data-flow-diagram-template.svg`
