# Process Flow Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Process & Flow Diagrams (`process-flow`)  
**Template ID:** `process-flow-diagram`  
**Layout:** `process_flow`  
**SVG:** `../svg/process-flow/60-process-flow-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Process Flow Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Steps, decisions, start/end
...
| Template title | read-only **InputText** | `Process Flow Diagram` |
...
- Canvas `aria-label="Process Flow Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/process-flow/60-process-flow-diagram-template.svg`
