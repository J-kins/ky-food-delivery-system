# Business Process Analysis — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Process & Flow Diagrams (`process-flow`)  
**Template ID:** `business-process-analysis`  
**Layout:** `side_by_side`  
**SVG:** `../svg/process-flow/59-business-process-analysis-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Business Process Analysis** so users begin with correct structure, guides, and placeholder regions.
- **Description:** As-Is / To-Be process columns
...
| Template title | read-only **InputText** | `Business Process Analysis` |
...
- Canvas `aria-label="Business Process Analysis template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/process-flow/59-business-process-analysis-template.svg`
