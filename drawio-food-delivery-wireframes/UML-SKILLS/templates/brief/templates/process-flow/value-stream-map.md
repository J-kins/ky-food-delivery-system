# Value Stream Map — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Process & Flow Diagrams (`process-flow`)  
**Template ID:** `value-stream-map`  
**Layout:** `value_stream`  
**SVG:** `../svg/process-flow/62-value-stream-map-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Value Stream Map** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Process steps, inventory, timeline
...
| Template title | read-only **InputText** | `Value Stream Map` |
...
- Canvas `aria-label="Value Stream Map template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/process-flow/62-value-stream-map-template.svg`
