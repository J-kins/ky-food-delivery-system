# UML Communication Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-communication-diagram`  
**Layout:** `communication_diagram`  
**SVG:** `../svg/uml/11-uml-communication-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Communication Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Objects with numbered message links
...
| Template title | read-only **InputText** | `UML Communication Diagram` |
...
- Canvas `aria-label="UML Communication Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/uml/11-uml-communication-diagram-template.svg`
