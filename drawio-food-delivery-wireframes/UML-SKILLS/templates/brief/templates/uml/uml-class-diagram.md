# UML Class Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-class-diagram`  
**Layout:** `class_diagram`  
**SVG:** `../svg/uml/01-uml-class-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Class Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** 3-class layout with relationship guides and multiplicity placeholders
...
| Template title | read-only **InputText** | `UML Class Diagram` |
