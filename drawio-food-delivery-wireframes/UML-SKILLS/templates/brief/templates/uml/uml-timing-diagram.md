# UML Timing Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-timing-diagram`  
**Layout:** `timing_diagram`  
**SVG:** `../svg/uml/13-uml-timing-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Timing Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Lifelines with state timeline tracks
...
| Template title | read-only **InputText** | `UML Timing Diagram` |
