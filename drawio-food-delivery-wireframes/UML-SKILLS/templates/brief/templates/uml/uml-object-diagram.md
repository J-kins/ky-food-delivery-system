# UML Object Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-object-diagram`  
**Layout:** `object_diagram`  
**SVG:** `../svg/uml/02-uml-object-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Object Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** 3-object layout with link placeholders
...
| Template title | read-only **InputText** | `UML Object Diagram` |
