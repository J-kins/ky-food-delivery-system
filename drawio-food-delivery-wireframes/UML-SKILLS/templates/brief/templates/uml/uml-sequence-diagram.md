# UML Sequence Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-sequence-diagram`  
**Layout:** `sequence_diagram`  
**SVG:** `../svg/uml/08-uml-sequence-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Sequence Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Lifelines, activation bars, message spaces
...
| Template title | read-only **InputText** | `UML Sequence Diagram` |
