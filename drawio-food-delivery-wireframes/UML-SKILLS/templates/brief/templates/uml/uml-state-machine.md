# UML State Machine Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-state-machine`  
**Layout:** `state_machine`  
**SVG:** `../svg/uml/10-uml-state-machine-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML State Machine Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** States and transition layout
...
| Template title | read-only **InputText** | `UML State Machine Diagram` |
...
- Canvas `aria-label="UML State Machine Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/uml/10-uml-state-machine-template.svg`
