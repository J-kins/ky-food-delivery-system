# UML Activity Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-activity-diagram`  
**Layout:** `activity_diagram`  
**SVG:** `../svg/uml/09-uml-activity-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Activity Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Swimlanes with action and decision placeholders
...
| Template title | read-only **InputText** | `UML Activity Diagram` |
