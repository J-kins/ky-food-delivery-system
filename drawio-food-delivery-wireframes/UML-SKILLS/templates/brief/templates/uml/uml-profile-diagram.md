# UML Profile Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-profile-diagram`  
**Layout:** `profile_diagram`  
**SVG:** `../svg/uml/14-uml-profile-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Profile Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Stereotypes and metaclass layout
...
| Template title | read-only **InputText** | `UML Profile Diagram` |
