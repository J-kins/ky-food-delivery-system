# UML Deployment Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-deployment-diagram`  
**Layout:** `deployment_diagram`  
**SVG:** `../svg/uml/04-uml-deployment-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Deployment Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Node layout with artifact placeholders
...
| Template title | read-only **InputText** | `UML Deployment Diagram` |
...
- Canvas `aria-label="UML Deployment Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/uml/04-uml-deployment-diagram-template.svg`
