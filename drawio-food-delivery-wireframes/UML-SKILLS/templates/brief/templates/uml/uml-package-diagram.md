# UML Package Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-package-diagram`  
**Layout:** `package_diagram`  
**SVG:** `../svg/uml/05-uml-package-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Package Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Package folders with dependency spaces
...
| Template title | read-only **InputText** | `UML Package Diagram` |
