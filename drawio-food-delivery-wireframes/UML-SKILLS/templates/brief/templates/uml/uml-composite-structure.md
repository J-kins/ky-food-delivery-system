# UML Composite Structure Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-composite-structure`  
**Layout:** `composite_structure`  
**SVG:** `../svg/uml/06-uml-composite-structure-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Composite Structure Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Outer part with internal sub-parts
...
| Template title | read-only **InputText** | `UML Composite Structure Diagram` |
...
- Canvas `aria-label="UML Composite Structure Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/uml/06-uml-composite-structure-template.svg`
