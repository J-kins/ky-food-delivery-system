# UML Use Case Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** UML Diagrams (`uml`)  
**Template ID:** `uml-use-case-diagram`  
**Layout:** `use_case_diagram`  
**SVG:** `../svg/uml/07-uml-use-case-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **UML Use Case Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** System boundary, actors, and use case ovals
...
| Template title | read-only **InputText** | `UML Use Case Diagram` |
