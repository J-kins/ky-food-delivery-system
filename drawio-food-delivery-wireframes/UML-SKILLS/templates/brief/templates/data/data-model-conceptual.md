# Conceptual Data Model — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Data & Database Diagrams (`data`)  
**Template ID:** `data-model-conceptual`  
**Layout:** `conceptual_entities`  
**SVG:** `../svg/data/64-data-model-conceptual-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Conceptual Data Model** so users begin with correct structure, guides, and placeholder regions.
- **Description:** High-level entity layout
...
| Template title | read-only **InputText** | `Conceptual Data Model` |
...
- Canvas `aria-label="Conceptual Data Model template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/data/64-data-model-conceptual-template.svg`
