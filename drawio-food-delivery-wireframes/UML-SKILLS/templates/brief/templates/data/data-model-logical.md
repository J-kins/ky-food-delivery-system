# Logical Data Model — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Data & Database Diagrams (`data`)  
**Template ID:** `data-model-logical`  
**Layout:** `logical_entities`  
**SVG:** `../svg/data/65-data-model-logical-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Logical Data Model** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Detailed entities with attributes
...
| Template title | read-only **InputText** | `Logical Data Model` |
