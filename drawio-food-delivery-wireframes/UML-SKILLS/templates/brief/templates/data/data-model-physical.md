# Physical Data Model — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Data & Database Diagrams (`data`)  
**Template ID:** `data-model-physical`  
**Layout:** `physical_tables`  
**SVG:** `../svg/data/66-data-model-physical-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Physical Data Model** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Tables, columns, constraints
...
| Template title | read-only **InputText** | `Physical Data Model` |
