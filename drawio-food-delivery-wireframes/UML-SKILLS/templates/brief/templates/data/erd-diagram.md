# ERD Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Data & Database Diagrams (`data`)  
**Template ID:** `erd-diagram`  
**Layout:** `erd`  
**SVG:** `../svg/data/63-erd-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **ERD Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Entities, relationships, cardinalities
...
| Template title | read-only **InputText** | `ERD Diagram` |
