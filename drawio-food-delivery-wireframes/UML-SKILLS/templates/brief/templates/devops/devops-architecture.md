# DevOps Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** DevOps & CI/CD Diagrams (`devops`)  
**Template ID:** `devops-architecture`  
**Layout:** `devops_toolchain`  
**SVG:** `../svg/devops/82-devops-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **DevOps Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Plan, code, build, test, release toolchain
...
| Template title | read-only **InputText** | `DevOps Architecture` |
...
- Canvas `aria-label="DevOps Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/devops/82-devops-architecture-template.svg`
