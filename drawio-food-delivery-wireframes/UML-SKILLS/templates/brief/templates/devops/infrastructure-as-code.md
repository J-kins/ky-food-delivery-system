# Infrastructure as Code — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** DevOps & CI/CD Diagrams (`devops`)  
**Template ID:** `infrastructure-as-code`  
**Layout:** `iac`  
**SVG:** `../svg/devops/85-infrastructure-as-code-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Infrastructure as Code** so users begin with correct structure, guides, and placeholder regions.
- **Description:** IaC definitions to cloud resources
...
| Template title | read-only **InputText** | `Infrastructure as Code` |
...
- Canvas `aria-label="Infrastructure as Code template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/devops/85-infrastructure-as-code-template.svg`
