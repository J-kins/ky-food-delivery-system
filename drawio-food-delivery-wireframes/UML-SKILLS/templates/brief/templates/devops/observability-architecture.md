# Observability Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** DevOps & CI/CD Diagrams (`devops`)  
**Template ID:** `observability-architecture`  
**Layout:** `observability`  
**SVG:** `../svg/devops/84-observability-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Observability Architecture** so users begin with correct structure, guides, and placeholder regions.
...
| Template title | read-only **InputText** | `Observability Architecture` |
...
- Canvas `aria-label="Observability Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/devops/84-observability-architecture-template.svg`
