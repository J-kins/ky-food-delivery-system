# CI/CD Pipeline — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** DevOps & CI/CD Diagrams (`devops`)  
**Template ID:** `cicd-pipeline`  
**Layout:** `pipeline_stages`  
**SVG:** `../svg/devops/81-cicd-pipeline-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **CI/CD Pipeline** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Source, build, test, deploy stages
...
| Template title | read-only **InputText** | `CI/CD Pipeline` |
