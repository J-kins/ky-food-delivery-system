# GitOps Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** DevOps & CI/CD Diagrams (`devops`)  
**Template ID:** `gitops-architecture`  
**Layout:** `gitops`  
**SVG:** `../svg/devops/83-gitops-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **GitOps Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Git repo, operator, cluster loop
...
| Template title | read-only **InputText** | `GitOps Architecture` |
...
- Canvas `aria-label="GitOps Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/devops/83-gitops-architecture-template.svg`
