# Hexagonal Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `hexagonal-architecture`  
**Layout:** `hexagonal`  
**SVG:** `../svg/architecture/22-hexagonal-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Hexagonal Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Domain core with ports and adapters
...
| Template title | read-only **InputText** | `Hexagonal Architecture` |
...
- Canvas `aria-label="Hexagonal Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/22-hexagonal-architecture-template.svg`
