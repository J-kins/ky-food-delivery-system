# Application Landscape — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `application-landscape`  
**Layout:** `grid_blocks`  
**SVG:** `../svg/architecture/17-application-landscape-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Application Landscape** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Application system grid
...
| Template title | read-only **InputText** | `Application Landscape` |
...
- Canvas `aria-label="Application Landscape template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/17-application-landscape-template.svg`
