# Microservices Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `microservices-architecture`  
**Layout:** `microservices`  
**SVG:** `../svg/architecture/20-microservices-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Microservices Architecture** so users begin with correct structure, guides, and placeholder regions.
...
| Template title | read-only **InputText** | `Microservices Architecture` |
...
- Canvas `aria-label="Microservices Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/20-microservices-architecture-template.svg`
