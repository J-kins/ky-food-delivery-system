# System Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `system-architecture`  
**Layout:** `service_blocks`  
**SVG:** `../svg/architecture/18-system-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **System Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Component and service layout
...
| Template title | read-only **InputText** | `System Architecture` |
...
- Canvas `aria-label="System Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/18-system-architecture-template.svg`
