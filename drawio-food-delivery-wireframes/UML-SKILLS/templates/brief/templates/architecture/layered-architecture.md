# Layered Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `layered-architecture`  
**Layout:** `layered_stack`  
**SVG:** `../svg/architecture/19-layered-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Layered Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** 4-layer stack
...
| Template title | read-only **InputText** | `Layered Architecture` |
...
- Canvas `aria-label="Layered Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/19-layered-architecture-template.svg`
