# Integration Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `integration-architecture`  
**Layout:** `hub_spoke`  
**SVG:** `../svg/architecture/28-integration-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Integration Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** ESB / API hub with integrations
...
| Template title | read-only **InputText** | `Integration Architecture` |
...
- Canvas `aria-label="Integration Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/28-integration-architecture-template.svg`
