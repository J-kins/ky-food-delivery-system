# Data Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `data-architecture`  
**Layout:** `layered_flow`  
**SVG:** `../svg/architecture/29-data-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Data Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Data flow layers
...
| Template title | read-only **InputText** | `Data Architecture` |
...
- Canvas `aria-label="Data Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/29-data-architecture-template.svg`
