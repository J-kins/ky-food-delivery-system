# Security Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `security-architecture`  
**Layout:** `security_zones`  
**SVG:** `../svg/architecture/30-security-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Security Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Security zones and controls
...
| Template title | read-only **InputText** | `Security Architecture` |
...
- Canvas `aria-label="Security Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/30-security-architecture-template.svg`
