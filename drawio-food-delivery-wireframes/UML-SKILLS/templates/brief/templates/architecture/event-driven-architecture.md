# Event-Driven Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `event-driven-architecture`  
**Layout:** `event_driven`  
**SVG:** `../svg/architecture/21-event-driven-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Event-Driven Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Producer, broker, consumer flow
...
| Template title | read-only **InputText** | `Event-Driven Architecture` |
...
- Canvas `aria-label="Event-Driven Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/21-event-driven-architecture-template.svg`
