# Solution Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `solution-architecture`  
**Layout:** `solution_blocks`  
**SVG:** `../svg/architecture/27-solution-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Solution Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** End-to-end solution layout
...
| Template title | read-only **InputText** | `Solution Architecture` |
...
- Canvas `aria-label="Solution Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/27-solution-architecture-template.svg`
