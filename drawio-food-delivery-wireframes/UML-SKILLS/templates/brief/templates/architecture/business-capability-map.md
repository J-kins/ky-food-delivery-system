# Business Capability Map — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `business-capability-map`  
**Layout:** `tier_columns`  
**SVG:** `../svg/architecture/16-business-capability-map-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Business Capability Map** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Tiered capability columns
...
| Template title | read-only **InputText** | `Business Capability Map` |
...
- Canvas `aria-label="Business Capability Map template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/16-business-capability-map-template.svg`
