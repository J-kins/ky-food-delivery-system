# Clean Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `clean-architecture`  
**Layout:** `concentric`  
**SVG:** `../svg/architecture/23-clean-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Clean Architecture** so users begin with correct structure, guides, and placeholder regions.
...
| Template title | read-only **InputText** | `Clean Architecture` |
...
- Canvas `aria-label="Clean Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/23-clean-architecture-template.svg`
