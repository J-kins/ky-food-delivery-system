# Enterprise Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `enterprise-architecture`  
**Layout:** `layered_stack`  
**SVG:** `../svg/architecture/15-enterprise-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Enterprise Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** 4-layer enterprise stack
...
| Template title | read-only **InputText** | `Enterprise Architecture` |
...
- Canvas `aria-label="Enterprise Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/15-enterprise-architecture-template.svg`
