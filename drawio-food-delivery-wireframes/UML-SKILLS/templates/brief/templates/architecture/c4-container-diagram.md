# C4 Container Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `c4-container-diagram`  
**Layout:** `c4_container`  
**SVG:** `../svg/architecture/25-c4-container-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **C4 Container Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Containers inside system boundary
...
| Template title | read-only **InputText** | `C4 Container Diagram` |
...
- Canvas `aria-label="C4 Container Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/25-c4-container-diagram-template.svg`
