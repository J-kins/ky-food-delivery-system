# C4 System Context — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Architecture Diagrams (`architecture`)  
**Template ID:** `c4-system-context`  
**Layout:** `c4_context`  
**SVG:** `../svg/architecture/24-c4-system-context-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **C4 System Context** so users begin with correct structure, guides, and placeholder regions.
- **Description:** System centre with users and external systems
...
| Template title | read-only **InputText** | `C4 System Context` |
...
- Canvas `aria-label="C4 System Context template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/architecture/24-c4-system-context-template.svg`
