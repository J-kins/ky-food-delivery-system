# Container Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Infrastructure Diagrams (`infrastructure`)  
**Template ID:** `container-architecture`  
**Layout:** `container_cluster`  
**SVG:** `../svg/infrastructure/35-container-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Container Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Cluster, pods, and services
...
| Template title | read-only **InputText** | `Container Architecture` |
...
- Canvas `aria-label="Container Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/infrastructure/35-container-architecture-template.svg`
