# Deployment Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Infrastructure Diagrams (`infrastructure`)  
**Template ID:** `deployment-architecture`  
**Layout:** `deployment_envs`  
**SVG:** `../svg/infrastructure/34-deployment-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Deployment Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Dev, staging, production environments
...
| Template title | read-only **InputText** | `Deployment Architecture` |
...
- Canvas `aria-label="Deployment Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/infrastructure/34-deployment-architecture-template.svg`
