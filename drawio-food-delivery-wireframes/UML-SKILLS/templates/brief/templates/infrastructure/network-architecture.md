# Network Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Infrastructure Diagrams (`infrastructure`)  
**Template ID:** `network-architecture`  
**Layout:** `network_topology`  
**SVG:** `../svg/infrastructure/32-network-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Network Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Router, switch, firewall topology
...
| Template title | read-only **InputText** | `Network Architecture` |
...
- Canvas `aria-label="Network Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/infrastructure/32-network-architecture-template.svg`
