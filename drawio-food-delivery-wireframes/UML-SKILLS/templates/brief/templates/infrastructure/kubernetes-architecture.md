# Kubernetes Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Infrastructure Diagrams (`infrastructure`)  
**Template ID:** `kubernetes-architecture`  
**Layout:** `kubernetes`  
**SVG:** `../svg/infrastructure/36-kubernetes-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Kubernetes Architecture** so users begin with correct structure, guides, and placeholder regions.
...
| Template title | read-only **InputText** | `Kubernetes Architecture` |
...
- Canvas `aria-label="Kubernetes Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/infrastructure/36-kubernetes-architecture-template.svg`
