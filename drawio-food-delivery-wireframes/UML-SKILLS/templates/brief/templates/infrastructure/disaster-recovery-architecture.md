# Disaster Recovery Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Infrastructure Diagrams (`infrastructure`)  
**Template ID:** `disaster-recovery-architecture`  
**Layout:** `dr_sites`  
**SVG:** `../svg/infrastructure/38-disaster-recovery-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Disaster Recovery Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Production and DR site layout
...
| Template title | read-only **InputText** | `Disaster Recovery Architecture` |
...
- Canvas `aria-label="Disaster Recovery Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/infrastructure/38-disaster-recovery-architecture-template.svg`
