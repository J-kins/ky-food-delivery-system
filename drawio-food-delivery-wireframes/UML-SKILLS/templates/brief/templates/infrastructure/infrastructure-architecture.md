# Infrastructure Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Infrastructure Diagrams (`infrastructure`)  
**Template ID:** `infrastructure-architecture`  
**Layout:** `infra_blocks`  
**SVG:** `../svg/infrastructure/31-infrastructure-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Infrastructure Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Servers, storage, and network
...
| Template title | read-only **InputText** | `Infrastructure Architecture` |
...
- Canvas `aria-label="Infrastructure Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/infrastructure/31-infrastructure-architecture-template.svg`
