# Cloud Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Infrastructure Diagrams (`infrastructure`)  
**Template ID:** `cloud-architecture`  
**Layout:** `cloud_vpc`  
**SVG:** `../svg/infrastructure/33-cloud-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Cloud Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** VPC, region, and availability zones
...
| Template title | read-only **InputText** | `Cloud Architecture` |
...
- Canvas `aria-label="Cloud Architecture template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/infrastructure/33-cloud-architecture-template.svg`
