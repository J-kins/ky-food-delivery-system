# Power–Interest Matrix — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Stakeholder Diagrams (`stakeholder`)  
**Template ID:** `power-interest-matrix`  
**Layout:** `quadrant_matrix`  
**SVG:** `../svg/stakeholder/52-power-interest-matrix-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Power–Interest Matrix** so users begin with correct structure, guides, and placeholder regions.
- **Description:** 2×2 power vs interest grid
...
| Template title | read-only **InputText** | `Power–Interest Matrix` |
...
- Canvas `aria-label="Power–Interest Matrix template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/stakeholder/52-power-interest-matrix-template.svg`
