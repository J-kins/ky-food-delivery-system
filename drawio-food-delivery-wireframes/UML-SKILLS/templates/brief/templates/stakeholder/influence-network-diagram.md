# Influence Network Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Stakeholder Diagrams (`stakeholder`)  
**Template ID:** `influence-network-diagram`  
**Layout:** `influence_network`  
**SVG:** `../svg/stakeholder/53-influence-network-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Influence Network Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Stakeholder nodes and influence arrows
...
- **When to use:** Starting a new **Stakeholder Diagrams** diagram without building layout from scratch.
- **User flow:** Gallery card → **wizard** confirms name → canvas opens → user replaces placeholders with stencils from the shape library.
- **Glossary terms:** **Matrix**, **Quadrant**, **Relationship**
...
| Template title | read-only **InputText** | `Influence Network Diagram` |
...
- Placeholders map to stencil categories from `stakeholder` and related shape packs.
...
- Canvas `aria-label="Influence Network Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/stakeholder/53-influence-network-diagram-template.svg`
