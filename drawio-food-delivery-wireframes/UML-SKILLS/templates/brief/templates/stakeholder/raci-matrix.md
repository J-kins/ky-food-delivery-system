# RACI Matrix — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Stakeholder Diagrams (`stakeholder`)  
**Template ID:** `raci-matrix`  
**Layout:** `raci_matrix`  
**SVG:** `../svg/stakeholder/55-raci-matrix-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **RACI Matrix** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Tasks × roles RACI grid
...
| Template title | read-only **InputText** | `RACI Matrix` |
