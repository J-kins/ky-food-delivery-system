# Salience Model — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Stakeholder Diagrams (`stakeholder`)  
**Template ID:** `salience-model`  
**Layout:** `venn_three`  
**SVG:** `../svg/stakeholder/54-salience-model-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Salience Model** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Power, legitimacy, urgency Venn
...
| Template title | read-only **InputText** | `Salience Model` |
