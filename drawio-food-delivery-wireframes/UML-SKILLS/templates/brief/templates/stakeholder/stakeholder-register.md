# Stakeholder Register — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Stakeholder Diagrams (`stakeholder`)  
**Template ID:** `stakeholder-register`  
**Layout:** `register_table`  
**SVG:** `../svg/stakeholder/56-stakeholder-register-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Stakeholder Register** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Stakeholder register columns
...
| Template title | read-only **InputText** | `Stakeholder Register` |
...
- Canvas `aria-label="Stakeholder Register template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/stakeholder/56-stakeholder-register-template.svg`
