# Stakeholder Map — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Stakeholder Diagrams (`stakeholder`)  
**Template ID:** `stakeholder-map`  
**Layout:** `stakeholder_map`  
**SVG:** `../svg/stakeholder/51-stakeholder-map-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Stakeholder Map** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Central system with surrounding stakeholders
...
| Template title | read-only **InputText** | `Stakeholder Map` |
