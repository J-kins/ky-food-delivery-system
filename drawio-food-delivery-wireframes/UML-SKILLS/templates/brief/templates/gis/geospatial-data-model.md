# Geospatial Data Model — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** GIS Diagrams (`gis`)  
**Template ID:** `geospatial-data-model`  
**Layout:** `geospatial_model`  
**SVG:** `../svg/gis/70-geospatial-data-model-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Geospatial Data Model** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Feature classes and attributes
...
| Template title | read-only **InputText** | `Geospatial Data Model` |
...
- Placeholders map to stencil categories from `gis` and related shape packs.
...
- Canvas `aria-label="Geospatial Data Model template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/gis/70-geospatial-data-model-template.svg`
