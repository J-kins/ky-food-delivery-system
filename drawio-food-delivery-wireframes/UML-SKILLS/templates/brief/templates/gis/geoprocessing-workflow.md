# Geoprocessing Workflow — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** GIS Diagrams (`gis`)  
**Template ID:** `geoprocessing-workflow`  
**Layout:** `tool_chain`  
**SVG:** `../svg/gis/72-geoprocessing-workflow-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Geoprocessing Workflow** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Sequential geoprocessing tools
...
| Template title | read-only **InputText** | `Geoprocessing Workflow` |
...
- Canvas `aria-label="Geoprocessing Workflow template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/gis/72-geoprocessing-workflow-template.svg`
