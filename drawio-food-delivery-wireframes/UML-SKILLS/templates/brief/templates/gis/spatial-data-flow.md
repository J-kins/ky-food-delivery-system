# Spatial Data Flow — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** GIS Diagrams (`gis`)  
**Template ID:** `spatial-data-flow`  
**Layout:** `spatial_flow`  
**SVG:** `../svg/gis/73-spatial-data-flow-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Spatial Data Flow** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Source to client spatial pipeline
...
| Template title | read-only **InputText** | `Spatial Data Flow` |
