# Map Design — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** GIS Diagrams (`gis`)  
**Template ID:** `map-design`  
**Layout:** `map_layout`  
**SVG:** `../svg/gis/71-map-design-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Map Design** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Map frame, legend, scale, compass
...
| Template title | read-only **InputText** | `Map Design` |
