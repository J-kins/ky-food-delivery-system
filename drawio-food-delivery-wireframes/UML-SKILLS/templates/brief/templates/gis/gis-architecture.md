# GIS Architecture — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** GIS Diagrams (`gis`)  
**Template ID:** `gis-architecture`  
**Layout:** `gis_stack`  
**SVG:** `../svg/gis/69-gis-architecture-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **GIS Architecture** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Server, database, client layout
...
| Template title | read-only **InputText** | `GIS Architecture` |
