# Threat Tree — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `threat-tree`  
**Layout:** `threat_tree`  
**SVG:** `../svg/project-management/48-threat-tree-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Threat Tree** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Root, branches, and leaf threats
...
| Template title | read-only **InputText** | `Threat Tree` |
