# PERT Chart — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `pert-chart`  
**Layout:** `pert_network`  
**SVG:** `../svg/project-management/44-pert-chart-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **PERT Chart** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Activity node network
...
| Template title | read-only **InputText** | `PERT Chart` |
