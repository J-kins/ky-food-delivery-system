# Work Breakdown Structure — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `work-breakdown-structure`  
**Layout:** `wbs_tree`  
**SVG:** `../svg/project-management/40-work-breakdown-structure-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Work Breakdown Structure** so users begin with correct structure, guides, and placeholder regions.
- **Description:** 4-level hierarchical WBS
...
| Template title | read-only **InputText** | `Work Breakdown Structure` |
...
- Canvas `aria-label="Work Breakdown Structure template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/project-management/40-work-breakdown-structure-template.svg`
