# Risk Heat Map — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `risk-heat-map`  
**Layout:** `heat_map`  
**SVG:** `../svg/project-management/47-risk-heat-map-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Risk Heat Map** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Colour-coded risk cells
...
| Template title | read-only **InputText** | `Risk Heat Map` |
...
- Canvas `aria-label="Risk Heat Map template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/project-management/47-risk-heat-map-template.svg`
