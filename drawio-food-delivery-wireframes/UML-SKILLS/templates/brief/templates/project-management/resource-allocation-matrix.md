# Resource Allocation Matrix — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `resource-allocation-matrix`  
**Layout:** `allocation_matrix`  
**SVG:** `../svg/project-management/49-resource-allocation-matrix-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Resource Allocation Matrix** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Resource × task grid
...
- **When to use:** Starting a new **Project Management Diagrams** diagram without building layout from scratch.
- **User flow:** Gallery card → **wizard** confirms name → canvas opens → user replaces placeholders with stencils from the shape library.
- **Glossary terms:** **Timeline**, **Data Grid**, **Wizard**
...
| Template title | read-only **InputText** | `Resource Allocation Matrix` |
...
- Placeholders map to stencil categories from `project-management` and related shape packs.
...
- Canvas `aria-label="Resource Allocation Matrix template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/project-management/49-resource-allocation-matrix-template.svg`
