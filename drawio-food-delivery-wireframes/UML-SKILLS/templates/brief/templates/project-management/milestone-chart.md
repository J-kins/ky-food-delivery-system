...
- **Goal:** Provide a ready-made blank canvas for **Milestone Chart** so users begin with correct structure, guides, and placeholder regions.
...
| Template title | read-only **InputText** | `Milestone Chart` |
...
- Canvas `aria-label="Milestone Chart template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/project-management/42-milestone-chart-template.svg`
