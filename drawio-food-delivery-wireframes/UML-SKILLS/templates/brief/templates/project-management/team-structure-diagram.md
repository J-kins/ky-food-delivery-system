# Team Structure Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `team-structure-diagram`  
**Layout:** `org_chart`  
**SVG:** `../svg/project-management/50-team-structure-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Team Structure Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Org chart with reporting lines
...
| Template title | read-only **InputText** | `Team Structure Diagram` |
...
- Canvas `aria-label="Team Structure Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/project-management/50-team-structure-diagram-template.svg`
