# Risk Matrix — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `risk-matrix`  
**Layout:** `risk_matrix`  
**SVG:** `../svg/project-management/46-risk-matrix-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Risk Matrix** so users begin with correct structure, guides, and placeholder regions.
- **Description:** 5×5 probability × impact matrix
...
| Template title | read-only **InputText** | `Risk Matrix` |
