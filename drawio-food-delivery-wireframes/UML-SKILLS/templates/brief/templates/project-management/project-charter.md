# Project Charter — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `project-charter`  
**Layout:** `charter_sections`  
**SVG:** `../svg/project-management/39-project-charter-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Project Charter** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Charter document sections
...
| Template title | read-only **InputText** | `Project Charter` |
...
- Canvas `aria-label="Project Charter template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/project-management/39-project-charter-template.svg`
