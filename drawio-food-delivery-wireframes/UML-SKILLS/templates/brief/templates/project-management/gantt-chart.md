# Gantt Chart — Template Design Brief
...
**Layout:** `gantt`  
**SVG:** `../svg/project-management/41-gantt-chart-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Gantt Chart** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Task list and timeline grid
...
| Template title | read-only **InputText** | `Gantt Chart` |
