# Critical Path Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `critical-path-diagram`  
**Layout:** `cpm_network`  
**SVG:** `../svg/project-management/45-critical-path-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Critical Path Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** CPM nodes with critical path highlight
...
| Template title | read-only **InputText** | `Critical Path Diagram` |
...
- Canvas `aria-label="Critical Path Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/project-management/45-critical-path-diagram-template.svg`
