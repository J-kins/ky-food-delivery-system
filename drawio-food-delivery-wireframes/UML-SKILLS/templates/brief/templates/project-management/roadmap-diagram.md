# Roadmap Diagram — Template Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category:** Project Management Diagrams (`project-management`)  
**Template ID:** `roadmap-diagram`  
**Layout:** `roadmap`  
**SVG:** `../svg/project-management/43-roadmap-diagram-template.svg`  
**Version:** 1.0  
...
- **Goal:** Provide a ready-made blank canvas for **Roadmap Diagram** so users begin with correct structure, guides, and placeholder regions.
- **Description:** Phases, timeline, and milestones
...
| Template title | read-only **InputText** | `Roadmap Diagram` |
...
- Canvas `aria-label="Roadmap Diagram template for project diagram"`.
- Each placeholder region named (e.g. "Class A placeholder").
- **Keyboard accessible** navigation between placeholders (Tab cycle).

## 10. Deliverables Checklist

- [ ] SVG at `../svg/project-management/43-roadmap-diagram-template.svg`
