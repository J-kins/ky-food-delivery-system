# New Diagram Wizard UI — UI/UX Design Brief
...
- **Goal:** Guided flow to pick a template and initialise project metadata.
...
- **Personas:** First-time and returning users creating a new diagram file.
- **Primary flow:** File → New → choose category → pick template → enter project name → Create.
