# Template Gallery UI — UI/UX Design Brief
...
- **Goal:** Browsable catalog of 86 diagram templates organized by category.
...
- **Personas:** Users who need the right starting layout (UML, architecture, Gantt, RACI, etc.).
- **Primary flow:** Filter category → preview thumbnail → Use template → wizard collects project name.
