# Template System — UI/UX Design Brief
...
- **Goal:** End-to-end diagram studio combining 86 blank templates with the stencil shape library.
...
- **Personas:** Architects, PMs, BAs, and engineers who start diagrams from standards-based layouts.
- **Primary flow:** Open app → browse template gallery OR open stencil editor → pick template → name project → compose → export.
