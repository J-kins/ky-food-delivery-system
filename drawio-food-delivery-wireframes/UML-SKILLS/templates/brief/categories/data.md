# Data & Database Diagrams — Category Design Brief
...
- **Goal:** Help users start **data & database diagrams** quickly with pre-structured blank canvases that match industry diagram conventions.
...
- **Glossary terms:** **Data Grid**, **Entity**, **Relationship**, **Pipeline**
...
- SVG folder: `svg/data/`
- Regenerate: `python svg/scripts/generate_templates.py --only data`

## 5. Templates in this category

`erd-diagram`, `data-model-conceptual`, `data-model-logical`, `data-model-physical`, `data-pipeline-architecture`, `data-lakehouse-architecture`
