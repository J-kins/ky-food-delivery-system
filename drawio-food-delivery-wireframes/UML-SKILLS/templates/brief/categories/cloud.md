# Cloud Architecture Diagrams — Category Design Brief
...
- **Goal:** Help users start **cloud architecture diagrams** quickly with pre-structured blank canvases that match industry diagram conventions.
- **Scope:** 7 template SVGs — see [../svg/TEMPLATE_LIBRARY.json](../svg/TEMPLATE_LIBRARY.json).
...
- **Glossary terms:** **Region**, **Service**, **Grid**, **Migration**
...
- SVG folder: `svg/cloud/`
- Regenerate: `python svg/scripts/generate_templates.py --only cloud`

## 5. Templates in this category

`aws-architecture`, `azure-architecture`, `gcp-architecture`, `multi-cloud-architecture`, `serverless-architecture`, `cloud-migration-architecture`, … (+1 more)
