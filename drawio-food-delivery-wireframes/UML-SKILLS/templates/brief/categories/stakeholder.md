# Stakeholder Diagrams — Category Design Brief

**Project:** UML-SKILLS Diagram Template Library  
**Category ID:** `stakeholder`  
**Template count:** 6  
**Version:** 1.0  
...
- **Goal:** Help users start **stakeholder diagrams** quickly with pre-structured blank canvases that match industry diagram conventions.
...
- **Glossary terms:** **Matrix**, **Quadrant**, **Relationship**, **Data Grid**
...
- SVG folder: `svg/stakeholder/`
- Regenerate: `python svg/scripts/generate_templates.py --only stakeholder`

## 5. Templates in this category

`stakeholder-map`, `power-interest-matrix`, `influence-network-diagram`, `salience-model`, `raci-matrix`, `stakeholder-register`
