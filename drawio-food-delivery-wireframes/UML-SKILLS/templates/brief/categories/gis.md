# GIS Diagrams — Category Design Brief
...
- **Goal:** Help users start **gis diagrams** quickly with pre-structured blank canvases that match industry diagram conventions.
- **Scope:** 5 template SVGs — see [../svg/TEMPLATE_LIBRARY.json](../svg/TEMPLATE_LIBRARY.json).
...
- **Glossary terms:** **Map**, **Legend**, **Layer**, **Flow**
...
- SVG folder: `svg/gis/`
- Regenerate: `python svg/scripts/generate_templates.py --only gis`

## 5. Templates in this category

`gis-architecture`, `geospatial-data-model`, `map-design`, `geoprocessing-workflow`, `spatial-data-flow`
