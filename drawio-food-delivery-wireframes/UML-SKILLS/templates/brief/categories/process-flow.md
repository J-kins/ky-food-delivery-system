# Process & Flow Diagrams — Category Design Brief
...
- **Goal:** Help users start **process & flow diagrams** quickly with pre-structured blank canvases that match industry diagram conventions.
...
- **Glossary terms:** **Swimlane**, **Flow**, **Decision**, **Wizard**
...
- SVG folder: `svg/process-flow/`
- Regenerate: `python svg/scripts/generate_templates.py --only process-flow`

## 5. Templates in this category

`business-process-model`, `data-flow-diagram`, `business-process-analysis`, `process-flow-diagram`, `workflow-diagram`, `value-stream-map`
