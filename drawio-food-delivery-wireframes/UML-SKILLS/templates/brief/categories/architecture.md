# Architecture Diagrams — Category Design Brief
...
- **Goal:** Help users start **architecture diagrams** quickly with pre-structured blank canvases that match industry diagram conventions.
- **Scope:** 16 template SVGs — see [../svg/TEMPLATE_LIBRARY.json](../svg/TEMPLATE_LIBRARY.json).
...
- **Glossary terms:** **Grid**, **System Context**, **Layer**, **Visual Hierarchy**
...
- SVG folder: `svg/architecture/`
- Regenerate: `python svg/scripts/generate_templates.py --only architecture`

## 5. Templates in this category

`enterprise-architecture`, `business-capability-map`, `application-landscape`, `system-architecture`, `layered-architecture`, `microservices-architecture`, … (+10 more)
