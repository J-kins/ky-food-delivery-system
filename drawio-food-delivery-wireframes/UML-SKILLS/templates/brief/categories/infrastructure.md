# Infrastructure Diagrams — Category Design Brief
...
- **Goal:** Help users start **infrastructure diagrams** quickly with pre-structured blank canvases that match industry diagram conventions.
- **Scope:** 8 template SVGs — see [../svg/TEMPLATE_LIBRARY.json](../svg/TEMPLATE_LIBRARY.json).
...
- **Glossary terms:** **Network**, **Topology**, **Container**, **Grid**
...
- SVG folder: `svg/infrastructure/`
- Regenerate: `python svg/scripts/generate_templates.py --only infrastructure`

## 5. Templates in this category

`infrastructure-architecture`, `network-architecture`, `cloud-architecture`, `deployment-architecture`, `container-architecture`, `kubernetes-architecture`, … (+2 more)
