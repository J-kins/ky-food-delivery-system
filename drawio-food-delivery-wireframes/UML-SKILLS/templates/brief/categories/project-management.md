# Project Management Diagrams — Category Design Brief
...
- **Goal:** Help users start **project management diagrams** quickly with pre-structured blank canvases that match industry diagram conventions.
- **Scope:** 12 template SVGs — see [../svg/TEMPLATE_LIBRARY.json](../svg/TEMPLATE_LIBRARY.json).
...
- **Glossary terms:** **Timeline**, **Data Grid**, **Wizard**, **Progress Indicator**
...
- SVG folder: `svg/project-management/`
- Regenerate: `python svg/scripts/generate_templates.py --only project-management`

## 5. Templates in this category

`project-charter`, `work-breakdown-structure`, `gantt-chart`, `milestone-chart`, `roadmap-diagram`, `pert-chart`, … (+6 more)
