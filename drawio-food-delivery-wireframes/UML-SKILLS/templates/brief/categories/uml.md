# UML Diagrams — Category Design Brief
...
- **Goal:** Help users start **uml diagrams** quickly with pre-structured blank canvases that match industry diagram conventions.
- **Scope:** 14 template SVGs — see [../svg/TEMPLATE_LIBRARY.json](../svg/TEMPLATE_LIBRARY.json).
...
- **Glossary terms:** **Card**, **Container**, **Visual Hierarchy**, **Progressive Disclosure**
...
- SVG folder: `svg/uml/`
- Regenerate: `python svg/scripts/generate_templates.py --only uml`

## 5. Templates in this category

`uml-class-diagram`, `uml-object-diagram`, `uml-component-diagram`, `uml-deployment-diagram`, `uml-package-diagram`, `uml-composite-structure`, … (+8 more)
