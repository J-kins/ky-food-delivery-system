#!/usr/bin/env python3
"""CLI for the Milestone Chart Generator."""
...
def main() -> int:
    ...
    parser.add_argument("input", help="Path to milestone_input.json or YAML file")
    ...
    try:
        build_milestone_chart(payload, out_path)
    except Exception as exc:
